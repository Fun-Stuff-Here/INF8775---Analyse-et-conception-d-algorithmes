...
def strassen_threshold(mat1, mat2, size, threshold=2**4):
    if size <= threshold:
    ...
    M1 = strassen_threshold(A11 + A22, B11 + B22, mid_point)
    M2 = strassen_threshold(A21 + A22, B11, mid_point)
    M3 = strassen_threshold(A11, B12 - B22, mid_point)
    M4 = strassen_threshold(A22, B21 - B11, mid_point)
    M5 = strassen_threshold(A11 + A12, B22, mid_point)
    M6 = strassen_threshold(A21 - A11, B11 + B12, mid_point)
    M7 = strassen_threshold(A12 - A22, B21 + B22, mid_point)
